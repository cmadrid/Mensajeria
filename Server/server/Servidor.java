    ...
    public void terminar() {
        try {
            ...
            for (int i = 0; i < escrituras.size(); i++) {
                ((DataOutputStream) salidas.get(i)).writeUTF("ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒOFFƒƒEl servidor ha sido cerrado.");
            ...
            try {
                ...
                while (running) {
                    ...
                    if (mensajeRecibido.length() >= 17) {
                        if (mensajeRecibido.substring(7, 17).equals("ƒƒcerrarƒƒ")) {
                            ...
                            usuarios.remove(n);
                            num--;
                            mensajeRecibido = mensajeRecibido.substring(17) + " ha abandonado la conversacion.";
